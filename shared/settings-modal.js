...
(function () {
    ...
    function renderStation() {
        ...
        <div class="stn-section">
            ...
            <div class="stn-grid2">
                ${field('Callsign',   'stn_callsign', s.callsign ?? '',  'text',   'e.g. YOURCALL')}
            ...
            <div style="margin-top:12px;">
                ...
                <textarea id="stn_notes" class="stn-input" rows="2" placeholder="e.g. BPQDASH Hub, Your Location">${escHtml(s.notes ?? '')}</textarea>
            </div>
        </div>
        <div class="stn-section">
    ...
    function renderStorm() {
        ...
        <div class="stn-section">
            ...
            <div class="stn-note" style="margin-top:8px;color:#9ca3af;font-size:.82rem;">
                ...
                Cron: <code>0 * * * * /usr/bin/python3 /var/www/html/bpq/scripts/storm-monitor.py &gt;&gt; /var/log/storm-monitor.log 2&gt;&amp;1</code>
            </div>
        </div>`;
    }
    ...
    function renderPaths() {
        ...
        <div class="stn-section">
            ...
            <div class="stn-grid1">
                ...
                ${field('Log Directory',        'path_log_dir',   paths.log_dir       ?? '', 'text', '/var/www/html/bpq/logs')}
                ${field('Backup Directory',     'path_backup_dir',paths.backup_dir    ?? '', 'text', '/var/www/html/bpq/scripts/prop-backups')}
            </div>
        </div>`;
