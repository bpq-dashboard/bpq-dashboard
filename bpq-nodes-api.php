 ...
 *
 * BPQ login sequence (confirmed from nc trace on BPQHOST):
 *   IAC negotiation -> user: -> YOURCALL -> password: -> dawgs1958
 *   -> "de YOURCALL>" (BBS prompt)
 *   -> NODE -> "Returned to Node AGNODE:YOURCALL-4" -> node list -> "AGNODE:YOURCALL-4}"
 *   -> ROUTES -> route table -> "AGNODE:YOURCALL-4}"
 *   -> BYE
 */
...
$BPQ_USER  = 'YOURCALL';
$BPQ_PASS  = 'dawgs1958';
$NODE_CALL = 'YOURCALL-4';   // own node callsign - excluded from node list
$TIMEOUT   = 12;
