<?php
/**
 * BPQDASH Network Hub Health Report
 * Deploy to: /var/www/bpq-dashboard/hub-report.php
 * Access: https://dashboard.example.com/hub-report.php
 */

// ── Database connection ───────────────────────────────────────
try {
    $pdo = new PDO(
        'mysql:host=localhost;dbname=bpqdash;charset=utf8mb4',
        'bpqdash',
...
<title>BPQDASH Hub Health Report — <?= date('Y-m-d') ?></title>
<style>
/* ── FONTS ── */
...
<div class="toolbar">
  <div>
    <div class="toolbar-brand">📡 BPQDASH Hub Health Report</div>
...
<div class="report">
  ...
  <div class="report-header">
    <div>
      <div class="report-title">BPQDASH Network <span>Hub Health Report</span></div>
      <div class="report-subtitle">YOURCALL · BPQHOST · All-time data from <?= h($overview['earliest']) ?> to <?= h($overview['latest']) ?></div>
    </div>
    <div class="report-stamp">
      Generated: <?= $generated ?><br>
      Database: bpqdash (MariaDB)<br>
      Report version: 1.0
    </div>
  </div>
  ...
  <div class="report-footer">
    <span>BPQDASH Hub Health Report · YOURCALL BPQHOST · <?= $generated ?></span>
    <span>CONFIDENTIAL — YOURCALL Station Use Only</span>
  </div>
